    ...
    <div className="rounded-lg bg-white p-8 shadow-md lg:col-span-3 lg:p-12 mt-12 w-full md:w-auto sm:w-full">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-4">
                  ...
                  >
                    <span className="absolute top-0 left-0 w-0 h-0 transition-all duration-200 border-t-2 border-[#e3282c] group-hover:w-full ease"></span>
                    <span className="absolute bottom-0 right-0 w-0 h-0 transition-all duration-200 border-b-2 border-[#e3282c] group-hover:w-full ease"></span>
                    <span className="absolute top-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-[#e3282c] groupgroup-hover:h-full ease"></span>
                    <span className="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-[#e3282c] group-hover:h-full ease"></span>
                    <span className="absolute inset-0 w-full h-full duration-300 delay-300 bg-[#e3282c] group opacity-0 group-hover:opacity-100"></span>
